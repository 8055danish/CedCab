	...
	<div class="column1">
		<table class="adminTable">
			...
			<?php if(count($rides)>0): ?>
				<tr><th>RIDE ID </th><th>RIDE DATE </th><th>FROM </th><th>TO </th><th>TOTAL DISTANCE </th><th>LUGGAGE </th><th>TOTAL FARE </th><th>USER ID </th></tr>
